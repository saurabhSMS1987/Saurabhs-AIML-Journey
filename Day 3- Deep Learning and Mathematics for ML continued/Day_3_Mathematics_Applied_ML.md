...
- [ ] Represent ML problem as system of linear equations
- [ ] Understand singular vs non-singular systems
- [ ] Explain why independence of features matters
- [ ] Set up linear regression problem in matrix form
- [ ] Solve for weights using linear algebra
- [ ] Describe how linear algebra powers modern ML
- [ ] Identify regression vs classification vs sequence problems
- [ ] Trace through complete ML workflow

---

## 🔗 Connection to Full Math Course
...
Day 3: Applications (TODAY)
  ├─ Systems of equations
  ├─ Singular/non-singular
  └─ Practical ML problems
  
Days 4+: Advanced Topics
...
**Insight 1:**
```
"Machine learning is just solving systems of linear equations.
The ML algorithm finds weights that best satisfy all equations."
```

**Insight 2:**
```
"More features = more dimensions = matrix multiplication
stays efficient. This is why linear algebra scales."
```

**Insight 3:**
```
"Every neural network layer is matrix multiplication
with activation. Linear algebra powers deep learning."
```
...
1. **Review Day 2** - Refresh on matrices, vectors, operations
2. **Practice** - Manually solve small systems by hand
3. **Implement** - Write Python code to solve X·w = y
4. **Apply** - Use real datasets (iris, housing prices)
5. **Extend** - Learn about multiple outputs, more features
...
X = np.array([[2000, 3], [1500, 2], [2500, 4]])
y = np.array([400, 300, 450])

# Least squares solution
w = np.linalg.lstsq(X, y)

# Prediction
y_pred = X @ w  # @ is matrix multiplication
```
